export const metadata = {
  ...
  description:
    "Book affordable and hassle-free car rentals. Drive your dreams with our reliable service and wide car selection in Goa and across India.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Book affordable and hassle-free car rentals. Drive your dreams with our reliable service and wide car selection in Goa and India.",
    url: "https://goadrive.com", // make sure your domain is correct
    siteName: "GOA DRIVE",
    images: [
      {
